  ...
  return (
    <div className="player player_container">
      ...
      <div className="player_container-sub player_life">
        ...
        <button className="buttons player_life-plus" onClick={increaselife}>
          {" "}
          +{" "}
        </button>
        <button className="buttons player_life-minus" onClick={decreaselife}>
          {" "}
          -{" "}
        </button>
      </div>
      <div className="header player_container-sub player_poison">
        ...
        <button className="buttons player_poison-plus" onClick={increasepoison}>
          {" "}
          +{" "}
        </button>
        <button
          className="buttons player_poison-minus"
          onClick={decreasepoison}
        >
          {" "}
          -{" "}
        </button>
