    ...
    <div className="portal">
      <Gradient className=" portal_container container">
        ...
        <form className="forms portal_form" onSubmit={handleSubmit}>
          <input
            className="inputs portal_input-username"
            placeholder="username"
            value={username}
            onChange={(e) => setUsername(e.target.value)}
          />
          <input
            className="inputs portal_password"
          ...
          <div className="portal_buttons">
            <button
              className="buttons portal_button submit"
              type="submit"
              disabled={loading}
            >
            ...
            <button
              className="buttons portal_button cancel"
              type="button"
              onClick={onCancel}
              style={{ marginLeft: 8 }}
            >
        ...
        {error && (
          <span className="spans" style={{ color: "red" }}>
            {error}
          </span>
        )}
      </Gradient>
