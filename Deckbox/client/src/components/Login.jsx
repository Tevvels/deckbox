      ...
      <Gradient className="portal_container container">
        ...
        <form className="forms portal_form" onSubmit={handleLogin}>
          <input
            ...
            className="inputs portal_input portal_input-username"
          />
          <input
            ...
            className="inputs portal_input portal_input-password"
          />
          <div className="portal_buttons">
            <button
              type="submit"
              className="buttons submit portal_button portal_button-submit"
            >
              Login
            </button>
            <button
            ...
            <button
              onClick={() => {
                setError(null);
                onShowForgot && onShowForgot();
              }}
              className=" buttons portal_button portal_button-forgot"
            >
              Forgot password
            </button>
          </div>
